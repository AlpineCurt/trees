...
class BinaryTree {
  ...
  minDepth(root = this.root) {
     ...
     return Math.min(this.minDepth(root.left) + 1, this.minDepth(root.right) + 1);
  ...
  /**What this was asking was unclear to me.  I originally wrote an algorithm
   * that started at the root and calculated the maximum sum going to a leaf. */
  maxSum() {
    let result = 0;
